...
export default function HistoryPage({ expenses = [], onDelete, onDeleteAll }) {
 ...
 hover:bg-red-100 :bg-red-500/20
 ...
 <div>
 <h3 className="text-lg font-bold text-gray-800 ">Delete All History</h3>
 ...
 <button
 onClick={() => setShowDeleteAllConfirm(false)}
 className="rounded-xl px-4 py-2.5 text-sm font-medium text-gray-600 transition hover:bg-gray-100 :bg-white/5">
 Cancel
 </button>
 <button
 ...
 <p className="text-sm text-gray-400 ">Your expenses will appear here once you start adding them.</p>
 </div>
 ) : (
 ...
 <th className="px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider text-gray-500 ">Delete</th>
 </tr>
 </thead>
 <tbody>
 <AnimatePresence>
 ...
 className="group border-b border-surface-100 transition-colors hover:bg-brand-50/50 :bg-brand-500/5 last:border-0">
 ...
 exp.source === "bill_upload" ? "text-emerald-600 "
 : exp.source === "bank_statement" ? "text-purple-600 "
 : "text-gray-400"
 }`}>
 ...
 hover:bg-red-50 hover:text-red-500 :bg-red-500/10 :text-red-400
