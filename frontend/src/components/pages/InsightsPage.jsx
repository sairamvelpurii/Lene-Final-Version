...
function getStyle(text) {
  ...
  if (l.includes("predict"))
    return { border: "border-l-purple-400", icon: Brain, ic: "text-purple-500", bg: "bg-purple-50 dark:bg-purple-500/5" };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <motion.div {...fadeUp(1)} className="card bg-gradient-to-br from-purple-50 to-brand-50 dark:from-purple-500/5 dark:to-brand-500/5">
        ...
        <motion.div {...fadeUp(2)} className="card bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-500/5 dark:to-teal-500/5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Suggested Savings</p>
          </div>
        ...
        <motion.div {...fadeUp(3)} className="card bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-500/5 dark:to-orange-500/5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Emergency Fund</p>
          </div>
      ...
      <motion.div {...fadeUp(4)} className="card">
        <div className="mb-5 flex items-center gap-2">
          ...
          <h3 className="text-base font-semibold text-gray-800 dark:text-white">Smart Recommendations</h3>
        </div>
        {insights.length === 0 ? (
      ...
      {budgetEntries.length > 0 && (
        <motion.div {...fadeUp(5)} className="card">
          <div className="mb-5 flex items-center gap-2">
            ...
            <h3 className="text-base font-semibold text-gray-800 dark:text-white">Recommended Budget Allocation</h3>
          </div>
      ...
      {/* Financial tips */}
      <motion.div {...fadeUp(6)} className="card bg-gradient-to-br from-brand-50 to-purple-50 dark:from-brand-500/5 dark:to-purple-500/5">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {[
            ...
            <div key={tip.title} className="rounded-xl bg-white/60 p-4 dark:bg-white/5">
              ...
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">{tip.desc}</p>
            </div>
          ))}
        </div>
      </motion.div>
