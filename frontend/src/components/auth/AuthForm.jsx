...
export default function AuthForm({ onAuth }) {
  ...
  async function submit(e) {
    ...
    try {
      ...
      if (err.response) {
        ...
        setError("Cannot reach the server. Make sure the backend is running on port 5000 (cd backend && python app.py).");
      } else {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-50 via-white to-purple-50 p-4 sm:p-6">
      {/* Decorative blobs */}
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 h-96 w-96 rounded-full bg-brand-200/30 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-5xl gap-8 lg:grid-cols-2 lg:gap-16">
        ...
        >
          <div className="mb-6 flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-600 to-purple-600 text-white font-bold text-xl shadow-lg">
              F
            </div>
            <span className="text-2xl font-bold text-gray-800">LENE-Smart Tracker</span>
          </div>
        ...
        >
          <div className="w-full rounded-3xl border border-surface-200 bg-white/90 p-8 shadow-card backdrop-blur-xl sm:p-10">
            ...
            <div className="mb-6 flex items-center gap-3 lg:hidden">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-brand-600 to-purple-600 text-white font-bold text-lg shadow-md">
                F
              </div>
              <span className="text-lg font-bold text-gray-800">LENE-Smart Tracker</span>
            </div>
